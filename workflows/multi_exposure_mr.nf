...
workflow MULTI_EXPOSURE_MR {
    ...
    CIS(GET_INPUT_VARIANTS.out.cis_exposure, GET_INPUT_VARIANTS.out.cis_outcome, GET_INPUT_VARIANTS.out.cis_LD, GET_INPUT_VARIANTS.out.cis_harm)
    ALL(GET_INPUT_VARIANTS.out.top_exposure, GET_INPUT_VARIANTS.out.top_outcome, GET_INPUT_VARIANTS.out.top_LD, GET_INPUT_VARIANTS.out.all_harm)
}
